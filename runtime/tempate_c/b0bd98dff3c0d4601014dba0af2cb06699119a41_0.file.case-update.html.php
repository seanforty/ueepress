<?php
/* Smarty version 3.1.30, created on 2017-11-11 09:13:16
  from "E:\www\ueepress2\app\admin\view\case-update.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a064eace48f46_33740375',
...
function content_5a064eace48f46_33740375 (Smarty_Internal_Template $_smarty_tpl) {
...
">
			<?php if (isset($_smarty_tpl->tpl_vars['res']->value['image']['img_url'])) {?>
...
$(function(){
	...
	$("#form-article-add").validate({
		...
		submitHandler:function(form){
			$(form).ajaxSubmit({
				url:"<?php echo url(array('path'=>'api/product/update'),$_smarty_tpl);?>
",
				type:"POST",
				success:function(res){
					layer.msg('更新成功!',{icon:1,time:1000});
					setTimeout("self.location='<?php echo url(array('path'=>'admin/cases/index'),$_smarty_tpl);?>
';",1000);
				},
				error:function(res){
