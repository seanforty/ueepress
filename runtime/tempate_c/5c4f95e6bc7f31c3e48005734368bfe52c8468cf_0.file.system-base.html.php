<?php
/* Smarty version 3.1.30, created on 2017-11-12 07:59:35
  from "E:\www\meswebsite\app\admin\view\system-base.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a078ee73bd6b9_08986327',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5c4f95e6bc7f31c3e48005734368bfe52c8468cf' => 
    array (
      0 => 'E:\\www\\meswebsite\\app\\admin\\view\\system-base.html',
      1 => 1510444764,
      2 => 'file',
    ),
  ),
...
function content_5a078ee73bd6b9_08986327 (Smarty_Internal_Template $_smarty_tpl) {
...
" class="input-text">
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">模块2-标题：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="indexmodule2_title" placeholder="" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['indexmodule2_title'];?>
" class="input-text">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">模块2-副标题：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="indexmodule2_subtitle" placeholder="" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['indexmodule2_subtitle'];?>
" class="input-text">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">模块2-链接：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="indexmodule2_link" placeholder="" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['indexmodule2_link'];?>
" class="input-text">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">模块2-分类ID：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="indexmodule2_cateid" placeholder="" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['indexmodule2_cateid'];?>
" class="input-text">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">模块3-标题：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="indexmodule3_title" placeholder="" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['indexmodule3_title'];?>
" class="input-text">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">模块3-副标题：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="indexmodule3_subtitle" placeholder="" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['indexmodule3_subtitle'];?>
" class="input-text">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">模块3-链接：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="indexmodule3_link" placeholder="" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['indexmodule3_link'];?>
" class="input-text">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">模块3-分类ID：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="indexmodule3_cateid" placeholder="" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['indexmodule3_cateid'];?>
" class="input-text">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">模块4-客户案例链接：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="indexmodule4_link" placeholder="" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['indexmodule4_link'];?>
" class="input-text">
					</div>
				</div>
			</div>
