<?php
/* Smarty version 3.1.30, created on 2017-11-12 08:31:23
  from "E:\www\meswebsite\app\admin\view\product-list.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a07965b6a8f55_19033818',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e495db7a166b1b1bf975822177da980e799aad88' => 
    array (
      0 => 'E:\\www\\meswebsite\\app\\admin\\view\\product-list.html',
      1 => 1510337597,
      2 => 'file',
    ),
  ),
...
function content_5a07965b6a8f55_19033818 (Smarty_Internal_Template $_smarty_tpl) {
...
')" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
			<a class="btn btn-primary radius" data-title="添加产品" data-href="<?php echo url(array('path'=>'admin/products/add'),$_smarty_tpl);?>
" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加产品</a>
		</span>
...
">
					...
					<td class="f-14 td-manage">
						<a style="text-decoration:none" class="ml-5" onClick="open_layer('产品编辑','<?php echo url(array('path'=>'admin/products/update','params'=>array('id'=>$_smarty_tpl->tpl_vars['val']->value['id'])),$_smarty_tpl);?>
...
',
		mode:'link',
		getLink : function(n){
			return '<?php echo url(array('path'=>"admin/products/index",'params'=>array("page"=>"'+n")),$_smarty_tpl);?>
;
		}
	});
});
...
function search_article()
{
    ...
    location.href = '<?php echo url(array('path'=>"admin/products/index",'params'=>array("keyword"=>"'+keyword+'","categoryid"=>"'+categoryid+'","logmin"=>"'+logmin+'","logmax"=>"'+logmax")),$_smarty_tpl);?>
;
}
