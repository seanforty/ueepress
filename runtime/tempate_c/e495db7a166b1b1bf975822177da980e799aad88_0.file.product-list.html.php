<?php
/* Smarty version 3.1.30, created on 2017-11-10 07:52:39
  from "E:\www\meswebsite\app\admin\view\product-list.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a04ea472594d9_81506530',
...
function content_5a04ea472594d9_81506530 (Smarty_Internal_Template $_smarty_tpl) {
...
">
					...
					<td class="f-14 td-manage">
						<a style="text-decoration:none" class="ml-5" onClick="open_layer('产品编辑','<?php echo url(array('path'=>'admin/product/update','params'=>array('id'=>$_smarty_tpl->tpl_vars['val']->value['id'])),$_smarty_tpl);?>
...
',
		mode:'link',
		getLink : function(n){
			return '<?php echo url(array('path'=>"admin/products/getList",'params'=>array("page"=>"'+n")),$_smarty_tpl);?>
;
		}
	});
});
...
function search_article()
{
    ...
    location.href = '<?php echo url(array('path'=>"admin/products/getList",'params'=>array("keyword"=>"'+keyword+'","categoryid"=>"'+categoryid+'","logmin"=>"'+logmin+'","logmax"=>"'+logmax")),$_smarty_tpl);?>
;
}
