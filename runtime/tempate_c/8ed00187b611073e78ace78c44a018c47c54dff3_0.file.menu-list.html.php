<?php
/* Smarty version 3.1.30, created on 2017-11-11 10:20:54
  from "E:\www\ueepress2\app\admin\view\menu-list.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a065e86ce5df3_55791925',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8ed00187b611073e78ace78c44a018c47c54dff3' => 
    array (
      0 => 'E:\\www\\ueepress2\\app\\admin\\view\\menu-list.html',
      1 => 1510366846,
      2 => 'file',
    ),
  ),
...
function content_5a065e86ce5df3_55791925 (Smarty_Internal_Template $_smarty_tpl) {
...
" method="get">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			<a href="javascript:;" onclick="del_all('<?php echo url(array('path'=>'api/Menulist/deleteAll'),$_smarty_tpl);?>
...
function addline(res) {
    ...
    str += '<a style="text-decoration:none" class="ml-5" onClick="pop_layer(\'菜单编辑\',\'<?php echo url(array('path'=>"admin/menulist/update",'params'=>array("id"=>"'+res.id+'","mid"=>"'+res.mid+'")),$_smarty_tpl);?>
\',\'800\',\'500\')" href="javascript:;" title="编辑">';
    str += '<i class="Hui-iconfont">&#xe6df;</i></a>';
    str += '<a style="text-decoration:none" class="ml-5"';
    str += 'onClick="del_data(this,\''+res.id+'\',\'<?php echo url(array('path'=>"api/menulist/delete"),$_smarty_tpl);?>
...
function addpage() {
	...
	console.log(pid);
	$.ajax({
        url:'<?php echo url(array('path'=>"api/menulist/addpage"),$_smarty_tpl);?>
',
        data:{
            id:pid,
			mid:mid
...
function addcate() {
	...
	var mid = $("#menulist").val();
	$.ajax({
		url:'<?php echo url(array('path'=>"api/menulist/addCate"),$_smarty_tpl);?>
',
		data:{
		    id:cid,
			mid:mid
...
{
	$.ajax({
		url:'<?php echo url(array('path'=>"api/menucontent/changeOrder"),$_smarty_tpl);?>
',
		data:{
		    id:id,
			listorder:t.value
